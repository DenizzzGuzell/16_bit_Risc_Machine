...
HD_PWD='C:/Users/denzz/Desktop/DERS/CORG/Project II/CorgProjectFPGA/SingleCycle_16bit_Risc_FPGA_verilog/SingleCycle_16bit_Risc_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Risc_16_bit.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Risc_16_bit.tcl -notrace
