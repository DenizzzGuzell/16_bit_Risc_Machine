...
HD_PWD='C:/Users/denzz/Desktop/DERS/CORG/Project II/CorgProjectFPGA/SingleCycle_16bit_Risc_FPGA/SingleCycle_16bit_Risc_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Risc_16_bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Risc_16_bit.tcl
